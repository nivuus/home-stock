 ...
 */function de(e){return pe({...e,state:!0,attribute:!1})}class me{constructor(e){this.hass=e}appeler(e,t={}){return this.hass.connection.sendMessagePromise({type:e,...t})}abonner(e){return this.hass.connection.subscribeMessage(e,{type:"home_stock/subscribe"})}appelerService(e,t,i={}){return this.hass.callService(e,t,i)}}function ge(e){return!!e&&"object"==typeof e&&"string"==typeof e.code&&"string"==typeof e.message}const fe=new Set(["not_loaded","invalid_field","invalid_value","not_found","already_exists","conversion_refused","shopping_refused"]);function ve(e){return fe.has(e.code)?e.message:"Une action a été refusée et n’a pas pu être envoyée."}const be="home_stock.file";class ye{constructor(e,t,i){this.stockage=e,this.envoyer=t,this.surRefus=i,this.actions=[],this.resultats=new Map,this.enVol=null;try{this.actions=JSON.parse(this.stockage.getItem(be)??"[]")}catch{this.actions=[]}}ajouter(e,t){const i={...t};return"string"!=typeof i.idempotency_key&&(i.idempotency_key=crypto.randomUUID()),this.actions.push({type:e,charge:i}),this.ecrire(),i.idempotency_key}taille(){return this.actions.length}async rejouer(){const e=this.enVol,t=(async()=>{e&&await e.catch(()=>{}),await this.boucle()})();this.enVol=t;try{await t}finally{this.enVol===t&&(this.enVol=null)}}async boucle(){for(;this.actions.length;){const e=this.actions[0],t=e.charge.idempotency_key;try{await this.envoyer(e.type,e.charge)}catch(i){if(ge(i)){this.actions.shift(),this.ecrire(),t&&this.resultats.set(t,"refusee"),this.surRefus?.(e,ve(i));continue}return}this.actions.shift(),this.ecrire(),t&&this.resultats.set(t,"envoyee")}}resultatDe(e){const t=this.resultats.get(e);return this.resultats.delete(e),t}viderResultats(){this.resultats.clear()}ecrire(){this.stockage.setItem(be,JSON.stringify(this.actions))}}class xe{constructor(e){this.fenetre=e,this.voie="companion"}disponible(){return Boolean(this.fenetre?.externalApp?.externalBus||this.fenetre?.webkit?.messageHandlers?.externalBus)}lire(){return new Promise(e=>{const t=this.fenetre.externalBus;let i=!1;const r=r=>{i||(i=!0,clearTimeout(s),this.fenetre.externalBus=t,e(r))},s=setTimeout(()=>r(null),6e4);this.fenetre.externalBus=e=>{const t="string"==typeof e?JSON.parse(e):e;return"bar_code/scan_result"===t.command?(this.envoyer({type:"bar_code/close"}),r(String(t.payload.rawValue))):"bar_code/aborted"!==t.command&&"bar_code/close"!==t.command||r(null),!0},this.envoyer({type:"bar_code/scan",payload:{title:"Scanner un article",description:"Visez le code-barres",alternative_option_label:"Saisir le code"}})})}envoyer(e){const t=JSON.stringify(e);this.fenetre.externalApp?.externalBus?this.fenetre.externalApp.externalBus(t):this.fenetre.webkit.messageHandlers.externalBus.postMessage(e)}}const $e=["ean_13","ean_8","upc_a","upc_e","code_128"];class _e{constructor(e){this.fenetre=e,this.voie="navigateur"}disponible(){return Boolean(this.fenetre?.BarcodeDetector&&this.fenetre?.navigator?.mediaDevices)}async lire(){try{const e=new this.fenetre.BarcodeDetector({formats:$e});this.flux=await this.fenetre.navigator.mediaDevices.getUserMedia({video:{facingMode:"environment"}});const t=this.fenetre.document.createElement("video");t.srcObject=this.flux,t.setAttribute("playsinline","true"),t.setAttribute("muted","true"),t.style.cssText="position:fixed;inset:0;width:100%;height:100%;object-fit:cover;z-index:2147483647;background:#000;",this.fenetre.document.body.appendChild(t),this.video=t,await t.play();for(let i=0;i<300;i+=1){const i=await e.detect(t);if(i.length)return String(i[0].rawValue);await new Promise(e=>this.fenetre.requestAnimationFrame(e))}return null}finally{this.arreter()}}arreter(){this.flux?.getTracks().forEach(e=>e.stop()),this.flux=void 0,this.video?.remove(),this.video=void 0}}class Ae{constructor(){this.voie="clavier"}disponible(){return!0}async lire(){return null}}const ke={label:"nom",brand:"marque",net_quantity:"poids net",image:"image",kcal_per_base_unit:"calories",proteins:"protéines",carbohydrates:"glucides",sugars:"sucres",added_sugars:"sucres ajoutés",fat:"matières grasses",saturated_fat:"graisses saturées",fiber:"fibres",salt:"sel",nutriscore:"Nutri-Score",nova:"classification NOVA",ecoscore:"Éco-score",allergens:"allergènes",traces:"traces",additives:"additifs",off_labels:"labels",off_raw:"réponse Open Food Facts"};function Ce(e,t,i){return null==e?"":"piece"===t?e.toFixed(2).replace(".",","):"g"===t||"ml"===t?null===i||i<=0?"":(e*i).toFixed(2).replace(".",","):""}function we(e,t,i){const r=Number.parseFloat(e.trim().replace(",","."));return Number.isFinite(r)?"piece"===t?r:"g"===t||"ml"===t?null===i||i<=0?null:r/i:null:null}function Ee(e){return e.known?e.article?.net_quantity??null:e.off?.net_quantity??null}function Se(e){return e&&"object"==typeof e&&"message"in e&&"string"==typeof e.message?e.message:"Une erreur est survenue."}let Pe=class extends ae{constructor(){super(...arguments),this.mode="rangement",this.productChoisi=null,this.nomNouveauProduit="",this.uniteNouveauProduit="piece",this.prixSaisi=null,this.poidsPaquet="",this.quantitePaquets=1,this.produitsBaseUnit={},this.rapportConversion=null,this.erreurConversion=null,this.erreurAction=null,this.erreurUnites=null,this.enCours=!1}willUpdate(e){if(e.has("resultat")&&this.resultat){this.productChoisi=this.resultat.preselected_product_id,this.nomNouveauProduit=this.resultat.off?.generic_name??"",this.uniteNouveauProduit=this.resultat.off?.net_unit??"piece";const e=Ee(this.resultat);this.poidsPaquet=null!==e?String(e):"",this.prixSaisi=null,this.quantitePaquets=1,this.rapportConversion=null,this.erreurConversion=null,this.erreurAction=null,this.erreurUnites=null,this.produitsBaseUnit={}}}updated(e){e.has("resultat")&&this.resultat&&!this.resultat.known&&this.resultat.candidates.length&&this.connexion&&this.chargerUnitesProduits()}async chargerUnitesProduits(){this.erreurUnites=null;try{const e=await this.connexion.appeler("home_stock/products/list"),t={};for(const i of e.products)t[i.id]=i.base_unit;this.produitsBaseUnit=t}catch{this.erreurUnites="Impossible de récupérer les informations du produit. Vérifiez la connexion."}}uniteConnue(){return this.resultat.known?this.resultat.product?.base_unit??null:"new"===this.productChoisi?this.uniteNouveauProduit:"number"==typeof this.productChoisi?this.produitsBaseUnit[this.productChoisi]??null:null}get poidsEffectif(){return function(e){const t=Number.parseFloat(e.trim().replace(",","."));return Number.isFinite(t)&&t>0?t:null}(this.poidsPaquet)}get valeurPrix(){if(null!==this.prixSaisi)return this.prixSaisi;const e=this.uniteConnue(),t="piece"===e?null:this.poidsEffectif;return Ce(this.resultat.price?.price_per_base_unit,e,t)}get raisonBlocage(){if(!this.resultat)return null;if(!this.resultat.known){if(!this.connexion)return"Connexion indisponible.";if(null===this.productChoisi)return"Choisissez un produit.";if("new"===this.productChoisi&&!this.nomNouveauProduit.trim())return"Donnez un nom au nouveau produit."}const e=this.uniteConnue();return null===e?this.erreurUnites??"Chargement des informations du produit…":"g"!==e&&"ml"!==e||null!==this.poidsEffectif?null:"Indiquez le poids du paquet pour calculer le prix."}get peutValider(){return!this.enCours&&null===this.raisonBlocage}enregistrerPoidsCorrige(e,t){const i={article_id:e,fields:{net_quantity:t}};this.file?this.file.ajouter("home_stock/article/update",i):this.connexion&&this.connexion.appeler("home_stock/article/update",i).catch(()=>{})}async valider(){if(this.peutValider){this.enCours=!0,this.erreurAction=null;try{const e=this.uniteConnue(),t="piece"===e?null:this.poidsEffectif,i=null===Ee(this.resultat);let r,s=[];if(this.resultat.known)r=this.resultat.article.id,null!==t&&i&&this.enregistrerPoidsCorrige(r,t);else{const e={code:this.resultat.code};this.resultat.off_raw&&(e.off=this.resultat.off_raw),this.resultat.off_source&&(e.off_source=this.resultat.off_source),"new"===this.productChoisi?e.new_product={name:this.nomNouveauProduit.trim(),base_unit:this.uniteNouveauProduit}:e.product_id=this.productChoisi,null!==t&&i&&(e.fields={net_quantity:t});const n=await this.connexion.appeler("home_stock/article/create",e);r=n.article_id,s=n.off_dropped_fields??[]}const n={articleId:r,quantite:"piece"===e?this.quantitePaquets:t*this.quantitePaquets,prixUnitaire:we(this.valeurPrix,e,t),mode:this.mode,offDroppedFields:s};this.dispatchEvent(new CustomEvent("article-pret",{detail:n,bubbles:!0,composed:!0}))}catch(e){this.erreurAction=Se(e)}finally{this.enCours=!1}}}async voirEffetConversion(){const e=this.resultat.conversion_offer;if(e&&this.connexion){this.erreurConversion=null;try{this.rapportConversion=await this.connexion.appeler("home_stock/product/convert_unit",{product_id:e.product_id,to_unit:e.to_unit,reference_quantity:e.reference_quantity,dry_run:!0})}catch(e){this.erreurConversion=Se(e)}}}async appliquerConversion(){const e=this.resultat.conversion_offer;if(e&&this.connexion&&this.rapportConversion){this.erreurConversion=null;try{this.rapportConversion=await this.connexion.appeler("home_stock/product/convert_unit",{product_id:e.product_id,to_unit:e.to_unit,reference_quantity:e.reference_quantity,dry_run:!1})}catch(e){this.erreurConversion=Se(e)}}}rendreRattachement(){return this.resultat.known?V:H`
    ...
    `:V}render(){if(!this.resultat)return V;const e=this.resultat,t=e.off?.label??e.article?.label??e.product?.name??"Article",i=e.off?.brand??e.article?.brand??null,r=e.article?.net_quantity??e.off?.net_quantity??null,s=e.product?.base_unit??e.off?.net_unit??"",n=e.off?.image??e.article?.image??null,o=e.off?.nutriscore??e.article?.nutriscore??null,a=function(e){const t=e.off?.nutrition_per_100?.kcal;if(null!=t)return t;const i=e.article?.kcal_per_base_unit,r=e.product?.base_unit;return null==i||"g"!==r&&"ml"!==r?null:100*i}(e),l=this.uniteConnue(),c="piece"===l?null:this.poidsEffectif,u="g"===l||"ml"===l?we(this.valeurPrix,l,c):null,h=null!=u?1e3*u:null,p="ml"===l?"L":"kg";return H`
      <section class="entete">
        ${n?H`<img class="image" src=${n} alt="" />`:V}
        <h2 class="nom">${t}</h2>
        ${i?H`<p class="marque">${i}</p>`:V}
        ${r?H`<p class="poids">${r} ${s}</p>`:V}
  ...
  `,e([pe({attribute:!1})],Re.prototype,"donnees",void 0),e([pe({attribute:!1})],Re.prototype,"connexion",void 0),e([pe({attribute:!1})],Re.prototype,"file",void 0),e([pe({attribute:!1})],Re.prototype,"enAttente",void 0),e([de()],Re.prototype,"ligneArmee",void 0),e([de()],Re.prototype,"prixSaisiParLigne",void 0),e([de()],Re.prototype,"erreurPrixParLigne",void 0),e([de()],Re.prototype,"deltaParLigne",void 0),Re=e([ce("home-stock-panier")],Re);let ze=class extends ae{constructor(){super(...arguments),this.donnees=null,this.enAttente=0,this.magasins=[],this.magasinChoisi=null,this.magasinSaisi="",this.erreurMagasins=null,this.clotureArmee=!1,this.enCours=!1,this.message=null}connectedCallback(){super.connectedCallback(),this.chargerMagasins()}async chargerMagasins(){if(this.erreurMagasins=null,this.donnees?.stores?.length&&(this.magasins=this.donnees.stores),this.connexion)try{const e=await this.connexion.appeler("home_stock/stores/list");this.magasins=e.stores}catch{this.erreurMagasins="Impossible de récupérer les magasins connus. Saisissez-en un."}}ecrire(e,t){if(!this.file)return Promise.resolve(!1);const i=this.file.ajouter(e,t);return this.avertirFile(),this.file.rejouer().then(()=>(this.avertirFile(),"envoyee"===this.file.resultatDe(i)))}avertirFile(){this.dispatchEvent(new CustomEvent("file-changee",{bubbles:!0,composed:!0}))}get magasinRetenu(){const e=this.magasinSaisi.trim();return e||this.magasinChoisi}async ouvrir(){if(this.enCours)return;this.enCours=!0,this.message=null;const e=this.magasinRetenu,t=await this.ecrire("home_stock/session/start",e?{store:e}:{});this.enCours=!1,t?this.dispatchEvent(new CustomEvent("session-changee",{detail:{action:"ouverte"},bubbles:!0,composed:!0})):this.message="Envoi en attente de réseau : la session s’ouvrira à la reconnexion."}async clore(){if(this.enCours)return;this.enCours=!0,this.message=null;const e=await this.ecrire("home_stock/session/close",{});this.enCours=!1,this.clotureArmee=!1,e?this.dispatchEvent(new CustomEvent("session-changee",{detail:{action:"fermee"},bubbles:!0,composed:!0})):this.message="Envoi en attente de réseau : la session se clora à la reconnexion."}rendreOuverture(){return H`
      ...
      ${this.magasins.length?H`
        <div class="pastilles">
          ${this.magasins.map(e=>H`
      ...
      ${this.erreurMagasins?H`<p class="erreur">${this.erreurMagasins}</p>`:V}
    ...
    `}rendreCloture(e){const t="shopping"===e.session.state,i=e.totals.pending;return H`
      ...
      `}
    `;var r}render(){return H`
      ${this.enAttente>0?H`
        <p class="en-attente">${this.enAttente} envoi${this.enAttente>1?"s":""} en attente de réseau</p>
      `:V}
      ${this.donnees?this.rendreCloture(this.donnees):this.rendreOuverture()}
      ${this.message?H`<p class="message">${this.message}</p>`:V}
    `}};function Fe(e,t){const i=new Date(t.getFullYear(),t.getMonth(),t.getDate()+e);return`${String(i.getFullYear()).padStart(4,"0")}-${String(i.getMonth()+1).padStart(2,"0")}-${String(i.getDate()).padStart(2,"0")}`}ze.styles=o`
    :host { display: block; padding: 12px; box-sizing: border-box; color: var(--primary-text-color); }
  ...
  `,e([pe({attribute:!1})],Me.prototype,"connexion",void 0),e([pe({attribute:!1})],Me.prototype,"file",void 0),e([pe({attribute:!1})],Me.prototype,"enAttente",void 0),e([de()],Me.prototype,"produits",void 0),e([de()],Me.prototype,"rayons",void 0),e([de()],Me.prototype,"emplacements",void 0),e([de()],Me.prototype,"quantitesParProduit",void 0),e([de()],Me.prototype,"erreurChargement",void 0),e([de()],Me.prototype,"recherche",void 0),e([de()],Me.prototype,"produitEditeId",void 0),e([de()],Me.prototype,"produitEnEdition",void 0),e([de()],Me.prototype,"brouillon",void 0),e([de()],Me.prototype,"erreurEdition",void 0),e([de()],Me.prototype,"enCours",void 0),e([de()],Me.prototype,"enAttenteEnvoi",void 0),Me=e([ce("home-stock-catalogue")],Me);const De=new Set(["Une resynchronisation Open Food Facts est déjà en cours."]);let Te=class extends ae{constructor(){super(...arguments),this.enAttente=0,this.rayons=[],this.emplacements=[],this.erreurChargement=null,this.resyncEnCours=!1,this.messageResync=null,this.erreurResync=null}connectedCallback(){super.connectedCallback(),this.charger()}async charger(){if(this.connexion){this.erreurChargement=null;try{const[e,t]=await Promise.all([this.connexion.appeler("home_stock/aisles/list"),this.connexion.appeler("home_stock/locations/list")]);this.rayons=e.aisles,this.emplacements=t.locations}catch{this.erreurChargement="Impossible de récupérer les rayons et les emplacements. Vérifiez la connexion."}}}avertirFile(){this.dispatchEvent(new CustomEvent("file-changee",{bubbles:!0,composed:!0}))}async deplacerRayon(e,t){const i=function(e,t,i){const r=t+i;if(r<0||r>=e.length)return null;const s=[...e];return[s[t],s[r]]=[s[r],s[t]],s}(this.rayons,e,t);if(null===i)return;if(this.rayons=i,!this.file)return;const r=this.file.ajouter("home_stock/aisles/reorder",{aisle_ids:i.map(e=>e.id)});this.avertirFile(),await this.file.rejouer(),this.avertirFile(),"refusee"===this.file.resultatDe(r)&&await this.charger()}async resynchroniser(){if(this.connexion&&!this.resyncEnCours){this.resyncEnCours=!0,this.messageResync=null,this.erreurResync=null;try{await this.connexion.appelerService("home_stock","resync_off",{all:!0}),this.messageResync="Resynchronisation lancée en tâche de fond — environ 40 minutes pour tout le catalogue. Les champs corrigés à la main ne sont jamais écrasés."}catch(e){this.erreurResync=function(e){const t=e&&"object"==typeof e&&"message"in e&&"string"==typeof e.message?e.message:null;return null!==t&&De.has(t)?t:"La resynchronisation n'a pas pu être lancée."}(e)}finally{this.resyncEnCours=!1}}}rendreRayons(){return 0===this.rayons.length?H`<p class="vide">Aucun rayon.</p>`:H`
  ...
  `,e([pe({attribute:!1})],Te.prototype,"connexion",void 0),e([pe({attribute:!1})],Te.prototype,"file",void 0),e([pe({attribute:!1})],Te.prototype,"enAttente",void 0),e([de()],Te.prototype,"rayons",void 0),e([de()],Te.prototype,"emplacements",void 0),e([de()],Te.prototype,"erreurChargement",void 0),e([de()],Te.prototype,"resyncEnCours",void 0),e([de()],Te.prototype,"messageResync",void 0),e([de()],Te.prototype,"erreurResync",void 0),Te=e([ce("home-stock-reglages")],Te);let Be=class extends ae{constructor(){super(...arguments),this.narrow=!1,this.ecran="scanner",this.enAttente=0,this.session=null,this.resultatCourant=null,this.derniereFiche=null,this.enAttenteRangement=[],this.erreurFile=null,this.navigationArmee=null,this.auRetourDuReseau=()=>{this.file?.rejouer().then(()=>{this.enAttente=this.file.taille(),this.file.viderResultats()})},this.surCodeLu=async e=>{try{const t=await this.connexion.appeler("home_stock/lookup",{code:e.detail.code});this.resultatCourant=t,this.ecran="fiche"}catch{this.derniereFiche={nom:e.detail.code,marque:null,image:null,statut:"Connexion indisponible — réessayez."}}},this.surArticlePret=e=>{const{articleId:t,quantite:i,prixUnitaire:r,mode:s,offDroppedFields:n}=e.detail;if("panier"===s){const e=this.file.ajouter("home_stock/session/add_line",{article_id:t,quantity:i,unit_price:r});return this.enAttente=this.file.taille(),this.file.rejouer().then(()=>{this.enAttente=this.file.taille(),this.file.resultatDe(e)}),this.derniereFiche=function(e,t,i=[]){return e?{nom:e.off?.label??e.article?.label??e.product?.name??e.code,marque:e.off?.brand??e.article?.brand??null,image:e.off?.image??e.article?.image??null,statut:t,ignores:i}:null}(this.resultatCourant,"Ajouté au panier.",n),this.resultatCourant=null,void(this.ecran="scanner")}const o=function(e,t,i,r){return{source:"autonome",id:`autonome-${crypto.randomUUID()}`,article_id:t,quantity:i,unit_price:r,product_name:e?.product?.name??e?.off?.label??e?.article?.label??e?.off?.generic_name??"Article",base_unit:e?.product?.base_unit??"piece",default_location_id:e?.product?.default_location_id??null,default_shelf_life_days:e?.product?.default_shelf_life_days??null,brand:e?.off?.brand??e?.article?.brand??null,image:e?.off?.image??e?.article?.image??null,net_quantity:e?.article?.net_quantity??e?.off?.net_quantity??null}}(this.resultatCourant,t,i,r);this.enAttenteRangement=[...this.enAttenteRangement,o],this.resultatCourant=null,this.ecran="rangement"},this.surSessionChangee=async()=>{await this.actualiserSession(),this.ecran="scanner"},this.surLigneAutonomeRangee=e=>{this.enAttenteRangement=this.enAttenteRangement.filter(t=>t.id!==e.detail.id)},this.surRangementTermine=()=>{this.navigationArmee=null,this.ecran="scanner"},this.surFileChangee=()=>{this.enAttente=this.file.taille()}}connectedCallback(){super.connectedCallback(),this.connexion=new me(this.hass),this.file=new ye(window.localStorage,(e,t)=>this.connexion.appeler(e,t),(e,t)=>{this.erreurFile=t}),this.enAttente=this.file.taille(),this.file.rejouer().then(()=>{this.enAttente=this.file.taille(),this.file.viderResultats()}),this.actualiserSession(),this.connexion.abonner(()=>{this.actualiserSession(),this.requestUpdate()}).then(e=>{this.isConnected?this.desabonner=e:e()}),window.addEventListener("online",this.auRetourDuReseau)}disconnectedCallback(){super.disconnectedCallback(),this.desabonner?.(),this.desabonner=void 0,window.removeEventListener("online",this.auRetourDuReseau)}async actualiserSession(){try{this.session=await this.connexion.appeler("home_stock/session/current")}catch{}}get lignesSessionARanger(){return this.session?.session&&"to_store"===this.session.session.state?this.session.lines.filter(e=>null===e.stored_at).map(e=>({...e,source:"session"})):[]}get lignesARanger(){return[...this.lignesSessionARanger,...this.enAttenteRangement]}demanderNavigation(e){"rangement"===this.ecran&&"rangement"!==e&&this.enAttenteRangement.length>0?this.navigationArmee=e:this.ecran=e}confirmerNavigation(){const e=this.navigationArmee;this.navigationArmee=null,e&&(this.ecran=e)}annulerNavigation(){this.navigationArmee=null}rendreNavigation(){if("fiche"===this.ecran)return V;if(this.navigationArmee)return H`
    ...
    `:V}rendreEcran(){return"fiche"===this.ecran&&this.resultatCourant?H`
        ...
        </home-stock-rangement>`:"session"===this.ecran?H`
        ...
        </home-stock-session>`:"catalogue"===this.ecran?H`
      ...
      </home-stock-scanner>`}render(){return H`${this.rendreNavigation()}${this.rendreErreurFile()}${this.rendreEcran()}`}};Be.styles=o`
  ...
  `,e([pe({attribute:!1})],Be.prototype,"hass",void 0),e([pe({attribute:!1})],Be.prototype,"narrow",void 0),e([de()],Be.prototype,"ecran",void 0),e([de()],Be.prototype,"enAttente",void 0),e([de()],Be.prototype,"session",void 0),e([de()],Be.prototype,"resultatCourant",void 0),e([de()],Be.prototype,"derniereFiche",void 0),e([de()],Be.prototype,"enAttenteRangement",void 0),e([de()],Be.prototype,"erreurFile",void 0),e([de()],Be.prototype,"navigationArmee",void 0),Be=e([ce("home-stock-panel")],Be);export{Be as PanneauGardeManger};
