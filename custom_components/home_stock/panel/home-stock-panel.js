      ...
      <section class="section">
        ...
        ${0===this.evenements.length?B`<span class="detail">Aucun événement enregistré.</span>`:this.evenements.map(e=>B`
              <span class="evenement-passe">
                ${function(e){const t=new Date(e);if(Number.isNaN(t.getTime()))return e;const i=e=>String(e).padStart(2,"0");return`${i(t.getDate())}/${i(t.getMonth()+1)}/${t.getFullYear()}`}(e.occurred_at)} — ${bt[e.kind]??e.kind}
              </span>`)}
